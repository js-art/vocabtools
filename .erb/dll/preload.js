...
const electronHandler = {
    ipcRenderer: {
        ...
        removeListener(channel, func) {
            electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.removeListener(channel, (_event, ...args) => func(...args));
        }
    },
};
